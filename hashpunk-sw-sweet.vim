...
call s:highlight('Comment', s:Grey30, s:clear, s:none)
...
call s:highlight('Statement', s:PaleGreen1, s:clear, s:none)
call s:highlight('Conditional', s:PaleGreen1, s:clear, s:none)
call s:highlight('Repeat', s:PaleGreen1, s:clear, s:none)
call s:highlight('Label', s:PaleGreen1, s:clear, s:none)
call s:highlight('Operator', s:PaleGreen1, s:clear, s:none)
call s:highlight('Keyword', s:PaleGreen1, s:clear, s:none)
call s:highlight('Exception', s:PaleGreen1, s:clear, s:none)

call s:highlight('PreProc', s:Grey54, s:clear, s:none)
call s:highlight('Include', s:PaleGreen1, s:clear, s:none)
call s:highlight('Define', s:Grey66, s:clear, s:none)
call s:highlight('Macro', s:Grey66, s:clear, s:none)
call s:highlight('PreCondit', s:PaleGreen1, s:clear, s:none)

call s:highlight('Type', s:PaleGreen1, s:clear, s:none)
call s:highlight('StorageClass', s:PaleGreen1, s:clear, s:none)
call s:highlight('Structure', s:PaleGreen1, s:clear, s:none)
call s:highlight('Typedef', s:PaleGreen1, s:clear, s:none)
...
call s:highlight('Underlined', s:Grey54, s:clear, s:none)
call s:highlight('Error', s:PaleGreen1, s:clear, s:none)
call s:highlight('Todo', s:PaleGreen1, s:clear, s:none)

call s:highlight('Directory', s:Grey93, s:clear, s:none)
call s:highlight('CursorLine', s:PaleGreen1, s:clear, s:none)
...
call s:highlight('CursorLineNr', s:PaleGreen1, s:Grey7, s:none)
...
call s:highlight('pythonBuiltin', s:Grey66, s:clear, s:none)
